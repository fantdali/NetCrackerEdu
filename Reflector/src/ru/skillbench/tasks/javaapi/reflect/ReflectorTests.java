...
class A{
	...
	public int functionA(Integer a) {
		return a;
	}
}
class B extends A{
	...
	public int functionB(Integer b) {
		return b;
	}
}
...
public class ReflectorTests {
	...
	public void getMethodResult()
		...
		impl.setClass(B.class);
		Constructor constructor = B.class.getDeclaredConstructor();
		B b = (B) constructor.newInstance();
		int res = b.functionA(2);
		assertEquals(res, impl.getMethodResult(null, "functionA", 2));
	}
}